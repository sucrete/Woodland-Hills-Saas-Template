...
export default async function HomePage() {
  const hoursInfo = await client.fetch("*[_type == 'siteSettings']{hours}");
  console.log("%c new, best data: "+ JSON.stringify(hoursInfo[0].hours, null, 2), 'color: red');
  const h = hoursInfo[0].hours
  return (
    <main>
      <section className="">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="sm:text-center lg:col-span-6 lg:text-left grid grid-cols-8 gap-2">
            <div className="left-side col-span-5 py-20">
              <div className="text-wrapper">
                <h1 className="text-4xl font-bold text-gray-900 tracking-tight sm:text-5xl md:text-6xl">
                  The Grass Doesn't Get
                  <span className="block text-green-500">Much Greener</span>
                </h1>

                <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                  <a href="/rack-rates" className="special-button">
                    Rack Rates
            ...
            <div className="right-side col-span-3">
              <Image
                className="player-man"
                priority
                src="/images/transparent-player.png"
                width={800}
                height={1200}
                alt=""
              />
